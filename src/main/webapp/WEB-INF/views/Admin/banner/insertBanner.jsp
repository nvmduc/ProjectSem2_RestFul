...
<div class="has-sidebar-left has-sidebar-tabs">
			...
			<div class="relative">
				<div class="d-flex">
					<div class="d-none d-md-block">
						<h1 class="nav-title">Add Banner</h1>
					</div>
				</div>
			</div>
			<!--Top Menu Start -->
	...
	<div class="container-fluid animatedParent animateOnce my-3">
		<div class="animated fadeInUpShort">
			<form:form action="insertBanner" modelAttribute="banner"
				method="post" enctype="multipart/form-data" id="get-quote">
				<div class="row">
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-6 mb-3">
								<label for="validationCustom01">Title Banner</label>
								<form:input path="titleBanner" type="text" class="form-control"
									id="validationCustom01" placeholder="Title Banner " />
							</div>
							<div class="col-md-6 mb-3">
								<label for="validationCustom01">Name Banner</label>
								<form:input path="nameBanner" type="text" class="form-control"
									id="validationCustom01" placeholder="Name Banner" />
							</div>
							...
							<div class="col-md-6 mb-3">
								...
								<form:input path="description" type="text" class="form-control"
									id="validationCustom01" placeholder="Description" />
							</div>
							<div class="col-md-12 mb-1" style="display: block">
								<label for="validationCustom02">Banner Status</label>
