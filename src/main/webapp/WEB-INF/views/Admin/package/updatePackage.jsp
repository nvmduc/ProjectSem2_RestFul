...
<div class="has-sidebar-left has-sidebar-tabs">
			...
			<div class="relative">
				<div class="d-flex">
					<div class="d-none d-md-block">
						<h1 class="nav-title">Update Package</h1>
					</div>
				</div>
			</div>
			<!--Top Menu Start -->
	...
	<div class="container-fluid animatedParent animateOnce my-3">
		<div class="animated fadeInUpShort">
			<form:form action="updatePackage" modelAttribute="pack"
				method="POST" enctype="multipart/form-data" id="get-quote">
				<div class="row">
					<div class="col-md-9">
						<div class="row">
							<form:input path="idPackage" type="hidden" readonly="readonly"
								class="form-control" id="validationCustom01"
								placeholder="Role ID" />
							<div class="col-md-6 mb-3">
								<label for="validationCustom01">Package Name</label>
								<form:input path="namePackage"
									class="form-control" id="validationCustom01"
									placeholder="Package Name" />
							</div>
							<div class="col-md-12 mb-1">
								<label for="file-upload" class="custom-file-upload">Image
									Package</label> <input type="file" name="image" />
							</div>
							<div class="col-md-12 mb-1" style="display: block">
								<label for="validationCustom02">Package Status</label>
								<div class="custom-control custom-radio custom-control-inline"
									style="display: flex;">
									<form:radiobutton path="statusPackage"
