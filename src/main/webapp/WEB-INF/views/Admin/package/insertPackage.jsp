...
<div class="has-sidebar-left has-sidebar-tabs">
			...
			<div class="relative">
				<div class="d-flex">
					<div class="d-none d-md-block">
						<h1 class="nav-title">Add Package</h1>
					</div>
				</div>
			</div>
			<!--Top Menu Start -->
	...
	<div class="container-fluid animatedParent animateOnce my-3">
		<div class="animated fadeInUpShort">
			<form:form action="insertPackage" modelAttribute="package"
					...
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-6 mb-3">
								...
								<form:input path="namePackage" type="text" class="form-control"
									id="validationCustom01" placeholder="Package Name" />
							</div>
