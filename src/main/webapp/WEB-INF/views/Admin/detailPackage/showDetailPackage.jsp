			...
			<div class="relative">
				<div class="d-flex">
					<div class="d-none d-md-block">
						<h1 class="nav-title">DetailPackage</h1>
					</div>
				</div>
			</div>
			<!--Top Menu Start -->
							...
							<div class="table-responsive">
								<table class="table table-hover">
									...
									<tbody>
											<tr class="no-b">
												<td>
													<h6>${dPack.descriptionPackage }</h6>
												</td>
												<td>
													${dPack.insuranceFees }
												</td>
												<td>${dPack.compensation }</td>
												<td>
													<div class="d-none d-lg-block">
														<span class="badge badge-success">${dPack.status == 1 ? "Show":"Hide" }</span>
													</div>
												</td>
												<td><span class="badge badge-success">${dPack.created_at}</span></td>
												<td>
												<a href="initUpdateDetailPackage?idPackage=${dPack.idDetailPackage }"
